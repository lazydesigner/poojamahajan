...
$sql = "INSERT INTO `profiles`( `page_url`, `page_h1`, `catigory`, `state`, `area`, `profile_name`, `profile_age`, `profile_height`, `profile_location`, `profile_type`, `profile_body`, `profile_images`, `profile_id`,`content`) VALUES ('$url','$page_h1','$service_type','$state','$area','$profile_name','$profile_age','$profile_height','$profile_location','$profile_type','$profile_body',' $list_of','$profile_id','$content')";

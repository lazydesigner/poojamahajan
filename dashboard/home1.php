...
";
            ...
            <h2>Indian Escorts(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts';
";
                                $res = mysqli_query($con, $sql);
                                $row = mysqli_fetch_array($res);
                                echo $row['a'] ?>)</h2>
            <div class="list-of-cities-row" id="list-of-cities-row">
                <div class="city-name-list-item">
                    <ul>
                        <li><a href="<?= get_url() ?>call-girls/delhi/">Delhi(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'delhi';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/agra/">Agra(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'agra';
";
                                                                            $res = mysqli_query($con, $sql);
                                                                            $row = mysqli_fetch_array($res);
                                                                            echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/jaipur/">Jaipur(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'jaipur';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/lucknow/">Lucknow(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'lucknow';
";
                                                                                    $res = mysqli_query($con, $sql);
                                                                                    $row = mysqli_fetch_array($res);
                                                                                    echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/guwahati/">Guwahati(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'guwahati';
";
                                                                                    $res = mysqli_query($con, $sql);
                                                                                    $row = mysqli_fetch_array($res);
                                                                                    echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/rishikesh/">Rishikesh(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'rishikesh';
";
                                                                                        $res = mysqli_query($con, $sql);
                                                                                        $row = mysqli_fetch_array($res);
                                                                                        echo $row['a'] ?>)</a></li>
                ...
                <div class="city-name-list-item">
                    <ul>
                        <li><a href="<?= get_url() ?>call-girls/goa/">Goa(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'goa';
";
                                                                            $res = mysqli_query($con, $sql);
                                                                            $row = mysqli_fetch_array($res);
                                                                            echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/ghaziabad/">Ghaziabad(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'ghaziabad';
";
                                                                                        $res = mysqli_query($con, $sql);
                                                                                        $row = mysqli_fetch_array($res);
                                                                                        echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/kota/">Kota(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'kota';
";
                                                                            $res = mysqli_query($con, $sql);
                                                                            $row = mysqli_fetch_array($res);
                                                                            echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/ahmedabad/">Ahmedabad(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'ahmedabad';
";
                                                                                        $res = mysqli_query($con, $sql);
                                                                                        $row = mysqli_fetch_array($res);
                                                                                        echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/arunachal-pradesh/">Arunachal-Pradesh(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'arunachal-pradesh';
";
                                                                                                        $res = mysqli_query($con, $sql);
                                                                                                        $row = mysqli_fetch_array($res);
                                                                                                        echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/bhopal/">Bhopal(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'bhopal';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                ...
                <div class="city-name-list-item">
                    <ul>
                        <li><a href="<?= get_url() ?>call-girls/gurugram">Gurugram(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'gurugram';
";
                                                                                    $res = mysqli_query($con, $sql);
                                                                                    $row = mysqli_fetch_array($res);
                                                                                    echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/faridabad/">Faridabad(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'faridabad';
";
                                                                                        $res = mysqli_query($con, $sql);
                                                                                        $row = mysqli_fetch_array($res);
                                                                                        echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/mumbai/">Mumbai(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'mumbai';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/ajmer/">Ajmer(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'ajmer';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/varanasi/">Varanasi(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'varanasi';
";
                                                                                    $res = mysqli_query($con, $sql);
                                                                                    $row = mysqli_fetch_array($res);
                                                                                    echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/dehradun/">Dehradun(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'dehradun';
";
                                                                                    $res = mysqli_query($con, $sql);
                                                                                    $row = mysqli_fetch_array($res);
                                                                                    echo $row['a'] ?>)</a></li>
                ...
                <div class="city-name-list-item">
                    <ul>
                        <li><a href="<?= get_url() ?>call-girls/udaipur/">Udaipur(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'udaipur';
";
                                                                                    $res = mysqli_query($con, $sql);
                                                                                    $row = mysqli_fetch_array($res);
                                                                                    echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/indore/">Indore(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'indore';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/noida/">Noida(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'noida';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/patna/">Patna(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'patna';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/visakhapatnam/">Visakhapatnam(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'visakhapatnam';
";
                                                                                                $res = mysqli_query($con, $sql);
                                                                                                $row = mysqli_fetch_array($res);
                                                                                                echo $row['a'] ?>)</a></li>
                        <li><a href="<?= get_url() ?>call-girls/manali/">Manali(<?php $sql = "SELECT COUNT(*) as a FROM profiles WHERE catigory = 'escorts' && state = 'manali';
";
                                                                                $res = mysqli_query($con, $sql);
                                                                                $row = mysqli_fetch_array($res);
                                                                                echo $row['a'] ?>)</a></li>

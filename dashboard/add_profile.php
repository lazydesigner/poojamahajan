            ...
            <div class="action-pannel">
                <form action="./pages/add_profile.php" method="POST">
                    <div class="page-detail">
                        ...
                        <div class="form-group-row">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Page H1" name="page_h1" id="page_h1">
                            </div>
    ...
    <script>
        ...
        document.getElementById('uploadImage').addEventListener('change', (e) => {
            ...
            fetch('./pages/upload_profile_images.php', {
                ...
                .then(data => {
                    if (data['status'] == 200) {
                        document.getElementById('uploaded_image_list').innerHTML += "<div><img src='./assets/images/profile_images/" + data['file_name'] + "' style='object-fit:cover' width='100px' height='100px'><input value=" + data['file_name'] + " name='image" + image_count + "' hidden></div>";
                        if (image_count == 5) {
        ...
        document.getElementById('upload_the_image').addEventListener('click', (e) => {
            ...
            for(i=0; i<array_of_images.length;i++){
                document.getElementById('preview-image-url').innerHTML += "<div style='width:150px;height:auto;overflow:hidden;background:white'><img src='"+array_of_images[i]+"' width='150px' height='200px' ><input  name='image" +(i+1)+ "' value='"+array_of_images[i]+"' style='padding:1% 2%;' readonly></div>";

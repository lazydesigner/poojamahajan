            ...
            <div class="action-pannel">
                ...
                <form action="./pages/add_city_detail.php" method="POST">
                    <div class="page-detail">
                        ...
                        <div class="form-group">
                            <input type="text" name="page_meta" class="form-control" placeholder="Page Meta Description">
                        </div>
                        <div class="form-group">
                            <input type="text" name="page_h1" class="form-control" placeholder="Page h1">
                        </div>
                        <div class="form-group">
                            <input type="text" name="city" class="form-control" placeholder="Enter City. Eg:Delhi, Lucknow">
                        </div>
                    </div>
                    <div class="page-detail">
                        <h2>Top Content</h2>
                        <textarea name="top_content" id="top-content" cols="30" rows="10"></textarea>
                    </div>
                    <div class="page-detail">
                        <h2>bottom Content</h2>
                        <textarea name="bottom_content" id="bottom-content" cols="30" rows="10"></textarea>
                    </div>

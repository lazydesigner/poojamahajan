            ...
            ?>
                <div class="profile-section-box">
                    ...
                    <div class="profile-section-box-detail">
                        ...
                        <div class="multiline-ellipsis" style="margin-bottom: 2%;"><?php if(!empty($row['page_description'])){ echo htmlspecialchars($row['page_description'], ENT_QUOTES, 'UTF-8');}else{echo htmlspecialchars($row['content'], ENT_QUOTES, 'UTF-8'); } ?></div>
